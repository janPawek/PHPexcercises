...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 22. Mrz 2024 um 19:47
...
--
CREATE DATABASE IF NOT EXISTS `be21_cr4_janpawek__biglibrary` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `be21_cr4_janpawek__biglibrary`;
...
(10, 'The Lost Symbol', 'https://m.media-amazon.com/images/I/71CxYdUk3wL._SX342_.jpg', '15-123-123-123-15', 'About sales tax (or VAT) About sales tax (or VAT)', 'Your order may include items from one or more Marketplace sellers. Since each of these sellers has different sales tax (or VAT) obligations, all Marketplace prices for orders shipped to delivery addresses within the EU and Northern Ireland are displayed as final prices indicated by the seller.', 'DVD', 'Dan', 'Brown', 'Kindl Edition', '167 Fleet Street, London EC4A 2EA', '2024-01-16', 'available'),
