...
$query = "INSERT INTO adoption (fk_pet_id, fk_user_id, adopt_date) VALUES ('$animal_id','$user_id', CURDATE())";
    if (mysqli_query($connect, $query) === true) {
        ...
        if (mysqli_query($connect, $query2) === true){
            ...
            $body =$name . "<img style='width:100%; height:300px; object-fit: contain;' src='animals/pictures/$picture'>" ."Location: " . $location . "<br>".$name ." will be a perfect friend"  ;
        }
        else {
            $class = "danger";
            $tags = '';
    ...
    <div class="container text-center">
        <div class="row justify-content-evenly py-5">
            ...
            <div class="alert alert-<?=$class;?> d-flex flex-column align-items-center" role="alert">
                <?=$message;?>
                <h2><?=$body;?></h2>
                <a href='home.php' class="btn" style="background-color:#a58d8b">Back</a>
            </div>
        </div>
    </div>
</body>
