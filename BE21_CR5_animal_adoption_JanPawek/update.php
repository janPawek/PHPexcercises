...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {       
        ...
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email',
        phone_number = '$phone_number', address = '$address', date_of_birth = '$date_of_birth', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', phone_number = '$phone_number', address = '$address', date_of_birth = '$date_of_birth' WHERE id = {$id}";
    }
    ...
    <div class="<?php echo $class; ?>" role="alert">
        ...
        <form  method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>phone_number</th>
                    <td><input class="form-control" type="text" name="phone_number" placeholder= "phone_number" value= "<?= $phone_number ?>" /></td>
                </tr>
                <tr>
                    <th>Address</th>
                ...
                <tr>
                    ...
                    <td><button name="submit" class="btn btn-danger" type= "submit">Save Changes</button></td>
