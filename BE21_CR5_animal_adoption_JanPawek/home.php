...
$sql ="SELECT * FROM animals";
    ...
    if($nOR == 0) {
        ...
        foreach($rows as $val) {
            ...
            <div class="card-body">
              <h5 class="card-title" style="font-size:2rem; color:#a58d8b; text-align:center">'.$val["name"].'</h5>
              <hr>
              <p class="card-text" style="text-align:center">'.$val["breed"].'<br> '.$val["location"].'</p>
              <a href="show.php?id='.$val["id"].'" class="m-1 btn  w-100" style="background-color:#a58d8b">SHOW DETAILS</a>
              <a href="adopt.php?id='.$val["id"].'" class="m-1 btn  w-100" style="background-color:#a58d8b">ADOPT ME</a>
            </div>
            </div>
            </div>
          </div>
...
<nav class="navbar navbar-expand-lg navbar-dark" style="background-color:#e66b6b">
...
<div class="container" style="background-color:white">
    <div>
        <p class="text-black profile_text" >Hi <?php echo $row['first_name']; ?><img class="userImage" src="pictures/<?php echo $row['picture']; ?>" alt="<?php echo $row['first_name']; ?>"></p>
        
    </div>
   
    <a style="width: 180px; margin-top:5%" class="btn btn-danger" href="logout.php?logout">Sign Out</a> <br>
    <a style="width: 180px; margin-top:0.5rem; margin-bottom:0.5em;" class="btn" style="background-color:#a58d8b" href="update.php?id=<?php echo $_SESSION['user'] ?>">Update your profile</a>
...
<div class="d-flex footer text-center align-items-center justify-content-center text-white" style="background-color: #e66b6b;
    height: 60px;">
