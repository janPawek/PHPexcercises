...
$error = false;
$fname = $lname = $email = $date_of_birth = $pass = $picture = $phone_number = $address = '';
$fnameError = $lnameError = $emailError = $dateError = $passError = $picError = $phone_numberError = $addressError = '';
if (isset($_POST['btn-signup'])) {
    ...
    if (!$error) {
        ...
        $query = "INSERT INTO users(first_name, last_name, password, date_of_birth, email, phone_number, address, picture)
                  VALUES('$fname', '$lname', '$password', '$date_of_birth', '$email', '$phone_number', '$address',  '$picture->fileName')";
...
<div class="container">
   <form class="w-75" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" autocomplete="off" enctype="multipart/form-data">
            ...
            <input type="email" name="email" class="form-control" placeholder="Enter Your Email" maxlength="40" value ="<?php echo $email ?>"  />
               ...
               <input type="text" name="phone_number" class="form-control" placeholder="Enter Your phone_number" maxlength="40" value ="<?php echo $phone_number ?>"  />
            ...
            <hr/>
            <button type="submit" class="btn btn-block" style="background-color:#a58d8b" name="btn-signup">Sign Up</button>
            <hr/>
