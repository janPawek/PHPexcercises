...
if (isset($_POST["submit"])) {
    ...
    if ($pictureArray->error === 0) {       
        ...
        telnumber = '$telnumber', address = '$address', date_of_birth = '$date_of_birth', picture = '$pictureArray->fileName' WHERE id = {$id}";
    } else {
        $sql = "UPDATE users SET first_name = '$f_name', last_name = '$l_name', email = '$email', telnumber = '$telnumber', address = '$address', date_of_birth = '$date_of_birth' WHERE id = {$id}";
    }
    ...
    <div class="<?php echo $class; ?>" role="alert">
        ...
        <form  method="post" enctype="multipart/form-data">
            <table class="table">
                ...
                <tr>
                    <th>TelNumber</th>
                    <td><input class="form-control" type="text" name="telnumber" placeholder= "TelNumber" value= "<?= $telnumber ?>" /></td>
                </tr>
                <tr>
                    <th>Address</th>
                ...
                <tr>
                    ...
                    <td><a href= "<?php echo $backBtn?>"><button class="btn btn-primary" type="button">Back</button></a></td>
                </tr>
            </table>
        </form>    
</div>
